...
public class StudentService {
    ...
    //@Transactional keeps the connection between the student
    //and the database whilst getting the address
    @Transactional
    public void insertAddressToStudent(Long id, Address address) {
        Student student = studentRepository.findById(id).orElseThrow(() -> new IllegalStateException(
                "Student with id "+ id +" doesn't exist!"));
